                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Ajouter Agent</div>
                            </div>
                     ...
                     <div class="row">
                    	<div class="col-lg-12">
                    		...
                    		<form action="{{route('store-agent.path')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="card-body row" id="bar-parent">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="prenom" class="form-control" id="simpleFormPrenom" placeholder="Prénom ">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="simpleFormContact">Contact</label>
                                                <input type="text" name="contact" class="form-control" id="simpleFormContact" placeholder="Contact">
                                            </div>
                                        </div>
